...
import packages.OrderPagess;
import packages.ProductsPagess;
import util.ConfigReader;

public class OrderTestss extends TestBasee {

	
	String userId = ConfigReader.getProperty("username");
	...
	public void labelsVerication() {
		...
		OrderPagess allOrdersPage = new OrderPagess();
	...
	public void availableProductsTest() {
		...
		ProductsPagess productsPage = new ProductsPagess();
